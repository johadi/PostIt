...
//   },
//   'INDEX PAGE: Signin button (Say user clicked singin button in home page)': (browser) => {
//     browser
...
//       .end();
//   },
//   'INDEX PAGE: Signup button (Say user clicked Signup button in index page)': (browser) => {
//     browser
//       .url(config.baseUrl)
